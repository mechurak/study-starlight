...
작성일: 2026-09-14
상태: 진행 중
지금 위치: D01 `keycloak-overview` 작성 완료 · D02 미착수 · Ubuntu P03·P11과 P05·P06 macOS browser는 blocked/보류 유지
실행 범위: D01만 — Keycloak의 역할과 세 신원 유입 경로, 본선/심화 범위를 설명하는 첫 페이지 작성과 관련 그룹·index 링크·실행 기록. D02 이후 본문·선택 실습은 포함하지 않는다.
