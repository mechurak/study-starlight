...
설정 의미·붙여넣기·모드 구분은 [1장 Vim 기본 조작](/cka/01-exam/#vim-최소-세트)을 참고한다.
...
- [CSR와 RBAC](/cka-udemy/08-security/#john-developer--제공된-csr로-인증서-발급과-pod-권한-연결): 실제 CSR 인코딩 → 승인·발급 → Role·Binding → `can-i`
