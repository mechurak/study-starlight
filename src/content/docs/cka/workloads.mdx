...
단일 인스턴스 DB라면 Deployment + PVC(PersistentVolumeClaim — 저장소 요청, [스토리지](/cka/storage/))로도 충분하다.
:::
...
버전 공존이 불가능할 때** 필요하다 ([스토리지](/cka/storage/)).
...
:::note[손 연습]
이 장 범위의 KodeKloud 실습 풀이 — [CKA 실습 4장 · Deployment rollout과 rollback](/cka-udemy/02-workloads/)과
[5장 · Job 완료와 실패](/cka-udemy/jobs/)
:::
