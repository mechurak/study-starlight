...
| `unbound immediate PersistentVolumeClaims` | PVC 미바인딩 | [스토리지](/cka/storage/) |
...
| `Unable to attach or mount volumes` | PV/CSI 문제 ([스토리지](/cka/storage/)) |
...
볼륨이 detach될 때까지 새 Pod은 계속 `ContainerCreating`에 머문다 ([스토리지](/cka/storage/)).
...
:::note[손 연습]
이 장 범위의 KodeKloud 실습 풀이 — [metrics와 로그](/cka-udemy/10-troubleshooting/),
