...
[macOS의 kind 장](/lab-environment/01-kind-macos/) 또는 [Ubuntu의 kind 장](/lab-environment/02-kind-ubuntu/)을
따른다. 이 장은 도구 설치법 대신 **어떤 연습에 어떤 환경을 고를지**만 구분한다.
...
- 읽기만 하면 안 된다. kind 환경([macOS](/lab-environment/01-kind-macos/) · [Ubuntu](/lab-environment/02-kind-ubuntu/)) + killercoda를 옆에 띄워두고 볼 것
