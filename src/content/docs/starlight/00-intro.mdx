...
content: "콘텐츠\nsrc/content/docs/\n마크다운 · MDX" { class: key }
structure: "구조\nsrc/data/decks.mjs · astro.config.mjs\n덱 manifest · 사이트 설정" { class: mute }
...
- 멘탈 모델은 3층 분리: **콘텐츠**(`src/content/docs/`) / **구조**(`src/data/decks.mjs` · `astro.config.mjs`) / **표현**(`src/components/`)
