...
```d2 layout=elk pad=40 title="스트리밍 SSR 순서 — 스켈레톤이 먼저 오고 피드·통계 조각이 차례로 도착한다"
...
b -> s: GET /dashboard
s -> b: "HTML — 헤더 + 스켈레톤 2개" { style.stroke-dash: 3 }
b.n1: "0.1초 — 이미 뭔가 보인다"
s -> b: Feed HTML 조각 { style.stroke-dash: 3 }
b.n2: "0.5초 — 피드 채워짐"
s -> b: Stats HTML 조각 { style.stroke-dash: 3 }
b.n3: "2.0초 — 완성"
```
