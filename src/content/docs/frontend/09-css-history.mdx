...
```d2 layout=elk pad=40 title="CSS 스타일링 접근의 변천 — 2005년 시맨틱 클래스, 2010년 OOCSS · SMACSS, 2013년 BEM, 2015년 CSS Modules, 2016년 CSS-in-JS, 2017년 Tailwind, 2025년 Tailwind v4 를 연대순으로 이은 사슬"
direction: down

y2005: 2005 · 시맨틱 클래스\n.article-title
y2010: 2010 · OOCSS · SMACSS\n재사용 단위를 정의하려는 시도
y2013: 2013 · BEM\n.block__element--modifier
y2015: 2015 · CSS Modules\n빌드 타임에 이름을 유일하게
y2016: 2016 · CSS-in-JS\nstyled-components · emotion
y2017: 2017 · Tailwind\n이름 짓기를 포기한다
y2025: 2025 · Tailwind v4\nCSS 자체가 설정 파일이 됨

y2005 -> y2010 -> y2013 -> y2015 -> y2016 -> y2017 -> y2025
```
...
```d2 layout=elk pad=40 title="BEM·CSS Modules·Tailwind가 규모에 따라 CSS 양이 어떻게 달라지는지 비교"
direction: right
...
b: "BEM · 5년 누적\n컴포넌트마다 새 클래스" { class: mute }
b2: "CSS 가 단조 증가 ❌" { class: bad }
m: "CSS Modules\n파일마다 새 클래스" { class: mute }
m2: "여전히 증가 ⚠️" { class: warn }
t: "Tailwind\n고정된 유틸리티 조합" { class: mute }
t2: "규모와 거의 무관 ✅" { class: ok }
