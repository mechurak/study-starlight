...
[Agent 배포 플랫폼 — kagent adapter](/agent-platform/08-kagent/#실행-수명주기는-다른-resource와-trigger로-표현한다)에서
이어 본다.
...
- [Agent 배포 플랫폼 — kagent adapter](/agent-platform/08-kagent/) — 실습 밖의 권한·격리·공급망 경계
