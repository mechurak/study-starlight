...
<DeckMap
  steps={[
    ...
    { label: '8~10장', href: '/observability/08-lab-setup/', title: '따라 하기', tone: 'ok',
      desc: '공식 LGTM · 공식 rolldice 앱 · 첫 통합 조사 · 첫 대시보드',
      note: 'Explore에서 원인을 찾고, 검증한 query를 반복해서 볼 화면으로 남기는가' },
  ]}
/>
