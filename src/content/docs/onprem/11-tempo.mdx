---
title: "11. 추적 — Tempo와 OpenTelemetry"
...
[10장](/onprem/10-loki/)의 로그에서 트레이스로 건너뛸 수 있다.
Grafana의 derived field가 그 링크를 만들어 준다 ([12장](/onprem/12-grafana/)).
:::
...
이 메트릭들은 Prometheus로 흘러가므로 [9장](/onprem/09-prometheus/)의 알림 규칙에 그대로 쓸 수 있다.
...
4. 셋 다 [12장](/onprem/12-grafana/)에서 실제로 연결한다.
...
| 저장은 되는데 조회 실패 | S3 접근 · 블록 포맷 | Tempo 로그, [6장](/onprem/06-minio/) 함정 넷 |
