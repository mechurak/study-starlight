...
| **Sealed Secrets 마스터키** | **Git의 모든 비밀을 영영 못 푼다** | 별도 금고 ([14장](/onprem/14-secrets/)) |
...
| 마스터키·CA 키 | **변경·갱신 시마다** | 0 | 금고에서 복원 ([14장](/onprem/14-secrets/)) | 분 |
...
3. **Sealed Secrets 마스터키**를 복원한다 — 없으면 Git의 비밀을 못 푼다 ([14장](/onprem/14-secrets/))
