...
| 이름 | 풀 이름 | 무엇인가 |
|---|---|---|
| **shadcn/ui** | — | 컴포넌트 소스를 내 레포에 복사해 주는 CLI 도구. 설치할 패키지가 없다 ([1장](/shadcn/01-what-is-shadcn/)) |
...
| **lucide** | — | shadcn/ui의 기본 아이콘 세트. 선 스타일 1500여 개 ([8장](/shadcn/08-icon-font/)) |
...
| **`--diff`** | — | 내 파일과 업스트림 최신본의 차이를 보여주는 옵션. **소유권 모델의 유일한 안전장치** |
