...
```d2 layout=elk pad=40 title="Identity → Network → Data → Evidence 순으로 통제가 쌓여 승인된 workload에 도달하는 네 층"
direction: down
...
id: "1. Identity\nSSO · MFA · SCIM · service principal" { class: key }
net: "2. Network\nCX/DX · VPC · endpoint · egress" { class: warn }
data: "3. Data\nUnity Catalog · IAM · row/column policy" { class: zone }
evid: "4. Evidence\nKMS · audit log · lineage · alert" { class: ok }
use: 승인된 workload { class: ok }
