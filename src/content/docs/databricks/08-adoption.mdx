...
```mermaid
flowchart LR
    ONP["사내 source"] -->|"CX/DX private route"| CLASSIC["Classic ingest<br/>customer-managed VPC"]
    CLASSIC --> S3["회사 S3<br/>Delta Bronze/Silver/Gold"]
    UC["Unity Catalog"] -. "권한 · lineage" .-> S3
    S3 --> SQL["SQL warehouse · BI"]
    S3 --> AI["Notebook · ML/AI"]
    ID["SSO · SCIM"] -.-> UC
    SEC["IAM · KMS · PrivateLink · audit"] -.-> CLASSIC
    SEC -.-> S3
