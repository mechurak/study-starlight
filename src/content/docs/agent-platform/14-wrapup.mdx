...
- [8. kagent adapter](/agent-platform/08-kagent/) · [9. Dapr Agents adapter](/agent-platform/09-dapr-agents/) · [10. AgentCore adapter](/agent-platform/10-agentcore/) — target 구현을 비교할 때
- [13. 두 Agent로 시작하기](/agent-platform/13-adoption/) — PoC acceptance test를 만들 때
