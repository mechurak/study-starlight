...
`durableWorkflowState`가 `unsupported`라는 점이 [12장 Dapr Agents](/agent-platform/12-dapr-agents/)와
갈리는 지점이다. 승인 대기가 며칠 걸리거나 중단 지점부터 이어져야 하는 Agent라면 target 선택을 다시 본다.
...
<LinkCard
  ...
  href="/agent-platform/12-dapr-agents/"
/>
