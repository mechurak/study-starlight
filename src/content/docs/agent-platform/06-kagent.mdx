...
못한다. adapter capability에는 다음 차이를 숨기지 않는다.

```text
residentA2A · suspendableActor · ephemeralJob · scheduledInvoke · durableState · persistentWorkspace
```
...
<LinkCard
  ...
  href="/agent-platform/07-dapr-agents/"
/>
