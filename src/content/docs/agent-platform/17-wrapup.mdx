...
> 결론부터 — **제품은 바뀌어도 Agent와 Tool의 ID·version·권한·감사 기록은 회사에 남아야 한다**
...
- [12. Dapr Agents adapter](/agent-platform/12-dapr-agents/) · [13. AgentCore adapter](/agent-platform/13-agentcore/) — target 구현을 비교할 때
