...
못한다. 이 차이는
[adapter contract의 capability profile](/agent-platform/05-adapter-contract/#capability로-차이를-드러낸다)에
...
제품 중립 분류와 trigger 계약은 [제품 밖의 domain model](/agent-platform/02-domain-model/#agent를-하나의-enum으로-나누지-않는다)에서
정의한다.
...
<LinkCard
  ...
  href="/agent-platform/08-dapr-agents/"
/>
