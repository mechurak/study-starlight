...
adapter release, kagent CRD/controller, AgentCore API contract를 Agent version과 분리해 관리한다. provider upgrade는
대표 canary Agent set으로 다음을 회귀 검증한다.
...
<LinkCard
  ...
  href="/agent-platform/10-adoption/"
/>
