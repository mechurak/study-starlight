...
이 덱은 먼저 제품 밖에 `Agent`·`AgentVersion`·`ToolVersion`·`Trigger`·`Grant`·`DeploymentTarget` 계약을 만든다. 그다음 같은 계약을
...
flowchart LR
    ...
    PORTAL --> CORE["제품 중립 계약<br/>Agent · Tool · Version · Grant · Deployment"]
