...
<DeckMap
  steps={[
    ...
    { label: '5~6장', href: '/agent-platform/05-adapter-contract/', title: 'Adapter와 MCP 공급 계약', tone: 'ok',
    ...
    { label: '7~9장', href: '/agent-platform/07-kagent/', title: '세 실행 adapter', tone: 'warn',
    ...
    { label: '10~11장', href: '/agent-platform/10-hybrid/', title: '하이브리드 운영', tone: 'bad',
      desc: 'data zone별 target 선택 · network · 감사 · SLO · 장애 격리와 복구',
      note: '온프렘과 AWS를 한 control plane에서 어떻게 운영하는가' },
    { label: '12~13장', href: '/agent-platform/12-adoption/', title: '도입과 마무리', tone: 'mute',
