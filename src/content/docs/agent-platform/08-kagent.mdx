...
|---|---|---|
| `Declarative` | model config, prompt, tool binding, deployment hint | 구성형·표준 runtime Agent |
...
- [kagent Agent 개념](https://kagent.dev/docs/kagent/concepts/agents) — Declarative·BYO Agent, tool과 HITL.
