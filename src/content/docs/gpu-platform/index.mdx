...
<DeckMap
  steps={[
    ...
    { label: '3~4장', href: '/gpu-platform/03-kserve/', title: '추론 평면', tone: 'zone',
      desc: 'KServe Standard부터 시작해 LiteLLM·vLLM·FastAPI를 연결하고 고급 LLM topology로 확장',
      note: '모델의 원하는 상태와 이용자 정책을 누가 소유하는가' },
