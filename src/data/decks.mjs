...
export const deckDefinitions = [
	...
	},
	{
		...
		icon: 'setting',
		aliases: ['AI Agent Platform', 'Agent Runtime', 'kagent', 'Dapr Agents', 'Amazon Bedrock AgentCore'],
		description: 'Agent·권한·배포 계약을 제품 밖에 둔다 — kagent·Dapr Agents·AgentCore를 교체 가능한 실행 어댑터로 연결하는 설계.',
		category: 'platform',
		groups: [
